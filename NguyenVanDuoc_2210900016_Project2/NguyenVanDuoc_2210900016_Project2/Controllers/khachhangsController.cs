...
namespace NguyenVanDuoc_2210900016_Project2.Controllers
{
    public class khachhangsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaKhach,HoTen,SDT,DiaChi")] khachhang khachhang)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaKhach,HoTen,SDT,DiaChi")] khachhang khachhang)
        {
            if (ModelState.IsValid)
            {
